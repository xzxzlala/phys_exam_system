  ...
  return (
    <main className="mx-auto max-w-4xl p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
        ...
        <Link href="/editor/upload" className="rounded border p-6 hover:bg-gray-50">
          <div className="text-xl font-semibold">在线编辑上传</div>
          <div className="text-gray-600 mt-2 text-sm">先上传后在线编辑 DOC/DOCX</div>
        </Link>
